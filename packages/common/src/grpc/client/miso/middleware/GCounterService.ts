...
export interface GCounterServiceClient extends grpc.Client {
...
export interface GCounterServiceHandlers extends grpc.UntypedServiceImplementation {
...
export interface GCounterServiceDefinition extends grpc.ServiceDefinition {
