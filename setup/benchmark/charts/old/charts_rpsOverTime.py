...
# input files
filesTime = ["../data/02_replication/rps/5N_RPS.csv", "../data/02_replication/rps/10N_RPS.csv", "../data/02_replication/rps/20N_RPS.csv", "../data/02_replication/rps/30N_RPS.csv", "../data/02_replication/rps/40N_RPS.csv",   "../data/02_replication/rps/50N_RPS.csv", "../data/02_replication/rps/50N_RPS_200ms.csv"]
...
# output file
output_file = "../data/02_replication/repTimeCompleteBucket/rpsMetrics_over_time.csv"
...
plt.savefig(os.path.join(figures_directory, f'rps_time_over_time.png'))
plt.show()