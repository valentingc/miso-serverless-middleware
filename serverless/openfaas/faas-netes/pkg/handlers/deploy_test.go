...
func Test_buildEnvVars_NoSortedKeys(t *testing.T) {
	...
	if len(coreEnvs) != 3 {
		t.Errorf("want: %d env-vars, got: %d", 3, len(coreEnvs))
		t.Fail()
	}
}
...
// 	if coreEnvs[3].Name != firstKey {
// 		t.Errorf("first want: %s, got: %s", firstKey, coreEnvs[3].Name)
// 		t.Fail()
// 	}
// }
...
// 	if coreEnvs[0].Name != "MISO_NODE_NAME" {
// 		t.Errorf("first want: %s, got: %s", firstKey, coreEnvs[0].Name)
// 		t.Fail()
// 	}

// 	if coreEnvs[3].Name != firstKey {
// 		t.Errorf("second want: %s, got: %s", secondKey, coreEnvs[3].Name)
// 		t.Fail()
// 	}

// 	if coreEnvs[4].Name != secondKey {
// 		t.Errorf("third want: %s, got: %s", thirdKey, coreEnvs[4].Name)
// 		t.Fail()
// 	}

// 	if coreEnvs[5].Name != thirdKey {
// 		t.Errorf("last want: %s, got: %s", lastKey, coreEnvs[5].Name)
// 		t.Fail()
// 	}

// 	if coreEnvs[6].Name != lastKey {
// 		t.Errorf("last want: %s, got: %s", lastKey, coreEnvs[6].Name)
// 		t.Fail()
// 	}
// }
